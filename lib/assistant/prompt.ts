...
- Right side: the results, with four tabs: "Total profit" (headline total profit with a P10–P90 range bar, cash profit, cattle finished, beef produced, chance of a loss), "Profit by sector" (a bar summary and a table of profit, per-head profit, margin, range of outcomes, and chance of a loss for each of the five sectors), "Cattle flow" (head exiting each stage with average exit weight, completed / still in chain / mortality shares, died, still being raised, break-even cattle price, break-even beef price), and "Details" (a chart and ledger of money in, money out, cash profit, and total profit by sector). The active tab shows "<year> USDA profile".
